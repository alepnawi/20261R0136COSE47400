#!/usr/bin/env python3
"""Run the isolated contrast-strength experiment."""
...
EXPERIMENT_NAME = "exp1_contrast_strength"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run the isolated contrast-strength DoLa experiment.")
...
def main():
    ...
    for row in selected_rows:
        ...
        print(
            {
                ...
                "decoder_names": list(EXP1_DECODER_NAMES),
            }
        )
        if args.dry_run:
            continue
        ...
        evaluator = ExperimentEvaluator(evaluator_args, EXP1_DECODER_NAMES)
        metadata = {
            ...
            "decoder_names": list(EXP1_DECODER_NAMES),
            "hypothesis": "contrast_strength_over_the_shallow_view_changes_truthfulness",
            "experiment_note": (
                "official_dola_vs_matched_alpha_dola_variants_with_alpha_applied_to_premature_log_probs"
            ),
        }
